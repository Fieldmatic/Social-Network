Vue.component('post',
    {
        ...
        template: `
            <div class="w-25 mx-auto rounded-2 mt-2"  style="border-color:lightgray; border-style:solid; border-radius: 10%;border-width: 1px;"">        
            ...
            <div class="row w-100 mx-auto pt-4 d-flex align-items-center mb-2">
                ...
                <div class="col-5 border-0 justify-content-end" style="font-size:0.9em "> 
                    <button id="postButton" type="button" class="btn btn-sm btn-primary float-end" style="width: 80%;" v-bind:disabled='!isDisabled' v-on:click="createPost();"> Post </button>
                </div>
            </div>     
        </div>        
        `,
